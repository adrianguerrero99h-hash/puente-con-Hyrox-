...
const TestSprintSledPush: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    ...
    return (
        <TestPageLayout onBack={onBack} title="Test Sprint Sled Push (Empuje)">
            <div className="bg-gray-900/50 border-2 border-gray-800 rounded-lg p-6 mb-8 text-center">
                <h2 className="text-xl font-bold text-amber-400 mb-4">¿En qué consiste el Test Sprint Sled Push?</h2>
                
                <div className="text-left inline-block space-y-4 text-gray-200">
                    <div>
                        <p><strong className="text-amber-400">A.</strong> Realiza 12,5m de empuje de trineo lo más rápido posible con el <strong className="text-white">P.O OPEN</strong> (152Kg hombres / 102Kg mujeres)</p>
                    ...
                    <div>
                        <p><strong className="text-amber-400">E.</strong> Realiza 12,5m de empuje de trineo lo más rápido posible con el <strong className="text-white">P.O PRO</strong> (202Kg hombres / 152Kg mujeres)</p>
...
export default TestSprintSledPush;
